...
const HashtagPerformance = lazy(() => import('@/app/(admin)/social/hashtag-performance/page'))
const Stories = lazy(() => import('@/app/(admin)/social/stories/page'))
const RecipeView = lazy(() => import('@/app/(admin)/recipes/view/page'))
...
const generalRoutes: RoutesProps[] = [
  ...
  {
    path: '/social/hashtag-performance',
    name: 'Hashtag Performance',
    element: <HashtagPerformance />,
  },
  {
    path: '/social/stories',
    name: 'Stories',
